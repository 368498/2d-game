...
config.PLAYER_DAMAGE_FLASH_DURATION = 0.25
config.SCREEN_SHAKE_DURATION = 0.18
config.SCREEN_SHAKE_AMPLITUDE = 6
config.ENABLE_DAMAGE_FLASH = false
config.PLAYER_HIT_KNOCKBACK = 120
